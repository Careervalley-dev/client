 ...
 return (
    ...
    >
      <div className="modal-header">
        <h2 className='font-dosis font-bold text-[24px]'>{formType === 'register' ? 'Register Now!' : 'Login'}</h2>
      ...
      <div className="modal-body">
        ...
        <div className="text-center mt-4">
          {formType === 'register' ? (
            <p>Already a user? <span onClick={toggleFormType} className="cursor-pointer text-[#235950] font-dosis font-semibold">Login</span>!</p>
          ) : (
            <p>New here? <span onClick={toggleFormType} className="cursor-pointer text-[#235950] font-dosis font-semibold">Register</span>!</p>
          )}
        </div>
      </div>
    </Modal>
