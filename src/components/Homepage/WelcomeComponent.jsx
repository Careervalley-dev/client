...
const WelcomeComponent = () => {
 return (
    <div className="font-anta mx-auto p-6 lg:p-20 bg-[#8aaca4] text-white animate-gradient-x">
      <h1 className="text-3xl lg:text-5xl font-bold text-center mb-5">
        WELCOME TO THE CAREER VALLEY 
      </h1>
      <p className='text-md lg:text-xl font-bold mb-7 text-center'>YOUR GATEWAY TO A BRIGHT FUTURE!</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {[
          ...
          <div key={index} className="bg-[white] text-black hover:bg-[#4c8474] hover:text-white p-6 rounded-lg shadow-lg transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-sm lg:texl-lg">{card.description}</p>
          </div>
        ))}
      </div>
    </div>
