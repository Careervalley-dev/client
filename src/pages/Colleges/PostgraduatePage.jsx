...
import BannerPg from "../../components/Colleges/BannerPg";
  ...
  return (
    <div>
      ...
      <div className="container flex flex-col justify-center items-center mx-auto px-4 py-12">
        <Heading normalText="Postgraduate" highlightText="Program" />
        {/* <h1 className="text-4xl font-bold text-center mb-6">Postgraduate</h1> */}
        <p className="text-lg text-gray-700 leading-relaxed mt-6 mb-12 text-center">
          Discover the best postgraduate colleges across major cities in India.
        ...
        <div className="grid place-items-center gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          {cities.map((city, index) => (
            <CityCard
              ...
              title={city.name}
              desc={city.desc}
              pageUrl={`/explorecity?city=${city.name}&programType=Postgraduate`}
            />
          ))}
        </div>
      </div>
